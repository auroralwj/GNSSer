...
namespace Geo.Algorithm
{
	...
	public class EigenvalueDecomposition
	{
		...
		private ArrayMatrix V; 			// storage of eigenvectors.
		private ArrayMatrix H;  			// storage of nonsymmetric Hessenberg form.
		...
		{
			if (A.RowCount != A.Columns) throw new ArgumentException("Matrix is not a square matrix.");
		...
		public ArrayMatrix EigenvectorMatrix
		{
			get 
			{ 
				return this.V; 
		...
		public ArrayMatrix DiagonalMatrix
		{
			get
			{
