...
namespace Geo.Algorithm
{
	...
	/// <summary>
	///  LU�ֽ⡣  LU decomposition of a rectangular matrix.
	/// </summary>
	/// <remarks>
	...
	{
		private ArrayMatrix LU;
		private int pivotSign;
		private int[] pivotVector;

		/// <summary>Construct a LU decomposition.</summary>	
		public LuDecomposition(ArrayMatrix A)
		{
			LU = (ArrayMatrix) A.Clone();
			double[][] lu = LU.Array;
			int rows = A.RowCount;
		...
		public double Determinant
		{
			get
			{
				if (LU.RowCount != LU.Columns) throw new ArgumentException("Matrix must be square.");
		...
		public ArrayMatrix LowerTriangularFactor
		{
			get
			{
