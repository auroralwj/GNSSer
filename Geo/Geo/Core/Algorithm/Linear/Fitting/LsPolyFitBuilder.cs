                ...
                case PositionOfMovingWindow.FormerOverlap:
                    {
                        ...
                        if (HasPrevious)
                        {
                            ...
                            val.Value = Geo.Utils.DoubleUtil.WeightedAverage(val.Value, val2.Value, dis1, dis2);
                            val.StdDev = Geo.Utils.DoubleUtil.WeightedAverage(val.StdDev, val2.StdDev, dis1, dis2);
                        }
                        return val;
                    }
