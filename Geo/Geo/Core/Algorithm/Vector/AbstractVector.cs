//2014.09.28， czs, create, 海鲁吐嘎查 通辽, 创建向量接口，为后继实现自我的、快速的、大规模的矩阵计算做准备
...
namespace Geo.Algorithm
{
    ...
    public abstract class AbstractVector : IVector, IToTabRow, IArithmeticOperation<IVector>
    {
        ...
        public AbstractVector() {
            ...
            this.FormatProvider = new EnumerableFormatProvider();
        }
        ...
        public override string ToString()
        {
            ...
            {
                if (i != 0) sb.Append(", ");              
                sb.Append(String.Format( new NumeralFormatProvider(), "{0:8.6}", this[i]));
            }
        ...
        public virtual System.Collections.Generic.IEnumerator<double> GetEnumerator() { return new List<Double>( OneDimArray).GetEnumerator();}
         ...
         /// <returns></returns>
         public virtual string GetUniqueKey(double resolution)
         {
