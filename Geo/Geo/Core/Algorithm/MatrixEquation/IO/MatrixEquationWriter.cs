...
namespace Geo.Algorithm
{
    ...
    /// 矩阵方程读写
    /// </summary>
    public class MatrixEquationWriter : AbstractMatrixEquationWriter
    {
        /// <summary>
        /// 本地文件读取
        /// </summary>
        ...
        public MatrixEquationWriter(string path, Encoding encoding = null)
        ...
        public MatrixEquationWriter(Stream stream, Encoding encoding)
