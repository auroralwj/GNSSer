...
namespace Geo.Algorithm
{
    ...
    /// 矩阵方程读写
    /// </summary>
    public class TextMatrixEquationWriter : AbstractMatrixEquationWriter
    {
        /// <summary>
        /// 本地文件读取
        /// </summary>
        ...
        public TextMatrixEquationWriter(string path, Encoding encoding = null)
        ...
        public TextMatrixEquationWriter(Stream stream, Encoding encoding)
