        ...
        static public void FtpUpload(string localFilePath, string ftpPath, string userName = "Anonymous", string password = "User@")  
       {
        ...
        public static List<string> DownloadFtpDirecotryOrFile(string ftpFolderOrFilePath, string extension = "*.*", string localFolder = @"C:\GnsserTemp\", string userName = "anonymous", string password = "User@", bool IsOverwrite = false, bool throwException = false)
        {
            ...
            foreach (var url in fileUrlPathes)
            {
                ...
                if (FtpDownload(url, localPath, userName, password, IsOverwrite, throwException))
                {
        ...
        public static bool FtpDownload(string urlpath, string savePath, string userName = "anonymous", string password = "User@", bool IsOverwrite = false, bool throwException = false)
        {
          ...
          //  request.UsePassive = false;
            ...
            {
                //检查目录的存在性，并创建 
                Geo.Utils.FileUtil.CheckOrCreateDirectory(Path.GetDirectoryName(savePath));  
        ...
        public static bool IsConnectedToInternet(){
          bool isConnected =Geo.Utils.NetUtil.IsConnected();
          if (isConnected)
          {
