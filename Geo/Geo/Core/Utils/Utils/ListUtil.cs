...
namespace Geo.Utils
{
    ...
    public static class ListUtil
    {
            ...
            where TKey : IComparable<TKey>
        {
            if(keyToDouble == null)
            {
                Geo.Utils.DoubleUtil.AutoSetKeyToDouble(out keyToDouble);//= new Func<TKey, double>((m) =>  Convert.ToDouble(m));
            }
        ...
        /// <returns></returns>
        public static List<T> GetAll<T>(List<T> keys, List<T> prns)
        {
