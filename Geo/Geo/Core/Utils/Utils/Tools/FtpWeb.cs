...
namespace Geo.Utils
{
    ...
    public class FtpWeb
    {
        ...
        public FtpWeb(string FtpServerIP, string FtpRemotePath, string FtpUserID = "Anonymous", string FtpPassword = "Anonymous")
        {
        ...
        /// </summary>
        /// <returns></returns>
        public string[] GetFileList(string extention = "*.*")
        {
            string[] downloadFiles;
            StringBuilder result = new StringBuilder();
            FtpWebRequest reqFTP;
            try
            {
                ...
                while (line != null)
                {
                    if (extention.Trim() != string.Empty && extention.Trim() != "*.*")
                    {

                        string mask_ = extention.Substring(0, extention.IndexOf("*"));
