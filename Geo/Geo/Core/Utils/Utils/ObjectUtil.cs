    ...
    /// </summary>
      ...
      { 
        ...
        static public List<string> GetPropertyNames(Type type)
          ...
          {
              var list = Geo.Utils.ObjectUtil.GetAttributes(obj, useDisplayName);
          ...
          {
              var navPropertyInfo = Geo.Utils.ObjectUtil.GetNavPropertyInfo(typeof(TEntity), typeof(TNavProperty));
          ...
          {
              return LinqUtil.GetPropertyName(expr);
          }
          ...
          public static int Compare<T>(T a, T b, string propertyName, bool Ascending)
          {
              ...
              var val1 = Geo.Utils.ObjectUtil.GetPropertyValue(a, propertyName);
              var val2 = Geo.Utils.ObjectUtil.GetPropertyValue(b, propertyName);
