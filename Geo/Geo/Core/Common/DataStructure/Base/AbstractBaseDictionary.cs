...
namespace Geo
{
    ...
    public abstract class AbstractBaseDictionary<TKey, TValue> : IDictionaryClass<TKey, TValue>, IDisposable
        // where TKey : IComparable<TKey>
    {
     ...
     //   [Obsolete("请不要直接在此属性上执行添加、删除等操作，直接使用对象方法操作")]
        ...
        public virtual void RemoveNotExist(IEnumerable< TKey> keys)
        {
            var toboDelte =  Geo.Utils.ListUtil.GetDifferences(this.Keys, keys); 
            this.Remove(toboDelte); 
        }
        /// <summary>
        /// 批量移除
        /// </summary>
