...
namespace Geo
{
    ...
    class KeyDictionary<TKey1, TKey2> : IEnumerable<KeyValuePair<TKey1, TKey2>>, ICloneable
    {
        #region 字段
        ...
        public KeyDictionary(int capacity)
            : this(0, null, null)
        { }
        public KeyDictionary(IEqualityComparer<TKey1> comp1, IEqualityComparer<TKey2> comp2)
            : this(0, comp1, comp2)
        { }
        public KeyDictionary(int capacity, IEqualityComparer<TKey1> comp1, IEqualityComparer<TKey2> comp2)
        {
            Initialize(capacity, comp1, comp2);
        }
        public KeyDictionary(KeyDictionary<TKey1, TKey2> copy)
        {
            if (copy == null)
        ...
        public object Clone()
        {
            return new KeyDictionary<TKey1, TKey2>(this);
        }
