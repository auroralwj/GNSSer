...
namespace Geo
{
    //2017.08.16, czs,created in hongqing, 提取关键字类型， 具有名称的参数和中误差。
    /// <summary>
    /// 具有名称的加权数字。
    /// </summary>
    public class NamedRmsedNumeral<TKey> : RmsedNumeral//, Namable
    {
        /// <summary>
        /// 具有名称的加权数字
        /// </summary>
        public NamedRmsedNumeral() { }
        /// <summary>
        /// 构造函数。
        /// </summary>
        ...
        public NamedRmsedNumeral(TKey name, double val, double rms)
            : base(val, rms)
        {
            this.Name = name;
        }
        ...
        {
            var o = obj as NamedRmsedNumeral;
            if (o == null) { return false; }
            return base.Equals(obj) && Name.Equals(o.Name);
        }

    }

    //2016.10.04, czs,created in hongqing, 具有名称的参数和中误差。
    /// <summary>
    /// 具有名称的参数和中误差。
    /// </summary>
    public class RmsedNumeralDictionary : BaseDictionary<string, RmsedNumeral>
    {
    ...
    /// 具有名称的加权数字。
    /// </summary>
    public class NamedRmsedNumeral : NamedRmsedNumeral<String>, Namable
    {
        /// <summary>
        /// 默认构造函数
        /// </summary>
        ...
        /// <param name="val"></param>
        /// <param name="rms"></param>
        public NamedRmsedNumeral(string name, double val, double rms)
            : base(name, val, rms)
        {
            this.Name = name;
        }
