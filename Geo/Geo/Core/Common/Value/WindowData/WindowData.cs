...
//2016.08.29, czs, create in 西安洪庆，提取窗口数据接口
...
namespace Geo
{
    ...
    public class WindowDataManager<TKey, TIndex, TValue> : BaseDictionary<TKey, WindowData<TIndex, TValue>>
         ...
         where TIndex : IComparable<TIndex>
    {
        ...
        /// <param name="maxKeyGap"></param>
        public WindowDataManager(int WindowSize, double maxKeyGap)
        {
        ...
        /// <returns></returns>
        public override WindowData<TIndex, TValue> Create(TKey key)
        {
            return new WindowData<TIndex, TValue>(WindowSize, MaxKeyGap);
        }
    }
        ...
        where TKey : IComparable<TKey>
    {
        ...
        {
            base.Init();
            Geo.Utils.DoubleUtil.AutoSetKeyToDouble(out KeyToDouble, this.TheVeryFirstKey);
        }
