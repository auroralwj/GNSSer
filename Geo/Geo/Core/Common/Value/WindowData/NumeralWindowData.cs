...
{  
    ...
    public class NumeralWindowData : IndexedWindowData<double>
    {
        ...
        {
            get { return Geo.Utils.DoubleUtil.GetLoopDifferValue(Data.ToArray()); }
        }
        ...
        { 
            return new NumeralWindowData(Geo.Utils.DoubleUtil.GetDiffer(Data.ToArray(), differCount));
        }
        ...
        {
            var val = Geo.Utils.DoubleUtil.GetAverageWithStdDev(this.GetSubList(from, count));
            return new RmsedNumeral(val[0], val[1]);        
        }
        ...
        {
            return new NumeralWindowData(Geo.Utils.DoubleUtil.GetNeatlyList(this, errorTimes));
        }
        ...
        {
            return (Geo.Utils.DoubleUtil.GetIndexesOfGrossError(this, errorTimes));
        }
