...
namespace Geo.IO
{
    ...
    /// 适用于整存争取的小文件。
    /// </summary>
    public abstract class AbstractReader<TProduct> : AbstractEncodedStreamer, IReader<TProduct>
    { 
        /// <summary>
        /// 本地文件读取
        /// </summary>
    ...
    /// 包含Stream, Encoding属性，用于输入输出。
    /// </summary>
    public abstract class AbstractReader<TProduct, TOption> : AbstractEncodedStreamer, IReader<TProduct, TOption>
    {
        /// <summary>
        /// 本地文件读取
        /// </summary>
