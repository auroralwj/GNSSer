...
namespace Geo.IO
{
    ...
    ///天文坐标文件读取
    /// </summary>
    public class IdAstroCoordReader : LineFileReader<IdAstroCoord>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        public IdAstroCoordReader(string filePath, string metaFilePath = null) : base(filePath, metaFilePath)
        { 
        }
        /// <summary>
        /// 构造函数
        ...
        public IdAstroCoordReader(string filePath, Gmetadata Gmetadata)
        ...
        /// <returns></returns>
        public override IdAstroCoord Parse(string[] items)
        {
            ...
            return new IdAstroCoord(name, coord);
        }
