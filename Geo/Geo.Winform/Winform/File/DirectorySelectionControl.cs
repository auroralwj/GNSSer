...
{ 
    ...
    public partial class DirectorySelectionControl : UserControl
    {
        ...
        /// </summary>
        public string Path { get { if (String.IsNullOrWhiteSpace(this.textBox_filepath.Text)) return ""; Geo.Utils.FileUtil.CheckOrCreateDirectory(Pathes[0]); return Pathes[0]; } set { this.textBox_filepath.Text = value; } }
        ...
        private void button_open_Click(object sender, EventArgs e)
        {
            ...
            Geo.Utils.FileUtil.OpenDirectory(Path);
        }
