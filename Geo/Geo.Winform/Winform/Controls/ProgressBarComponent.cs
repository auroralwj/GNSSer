...
namespace Geo.Winform.Controls
{
    ...
    public partial class ProgressBarComponent : UserControl, Geo.IProgressCounter
    {
        /// <summary>
        ...
        public void ShowClassifyProcessInfo(string message)  {  Geo.Utils.FormUtil.ShowNotice(label_classfyProcessInfo, message, false); }
        /// <summary>
        /// 显示分类信息
        /// </summary>
        /// <param name="message"></param>
        public void ShowClassifyInfo(string message) {  Geo.Utils.FormUtil.ShowNotice(label_classfiyInfo, message, false); }
        ...
        public void ShowInfo(string txt)
        {
            if (MinShowingIntervalSec <= (DateTime.Now - LastShowingTime).TotalSeconds)
            {
                ...
                Geo.Utils.FormUtil.ShowNotice(label_progressInfo, txt, false);
            }
        }
