...
namespace Geo.Winform.Controls
{
    public partial class TimePeriodControl : UserControl
    {
        ...
        /// 获取
        /// </summary>
        public Geo.Times.TimePeriod TimePeriod { get { return new Times.TimePeriod(TimeFrom, TimeTo); } }
        /// <summary>
        /// 设置
        /// </summary>
        /// <param name="TimePerid"></param>
        public void SetTimePerid(Geo.Times.TimePeriod TimePerid)
        {
            TimeFrom = TimePerid.Start.DateTime;
            TimeTo = TimePerid.End.DateTime;
        }
        public void SetTimePerid(Geo.Times.BufferedTimePeriod TimePerid)
        {
            TimeFrom = TimePerid.Start.DateTime;
            TimeTo = TimePerid.End.DateTime;
        } 
