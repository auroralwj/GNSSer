...
namespace Geo.Winform.Controls
{
    ...
    /// </summary>
    public partial class RmsedVectorRenderControl : UserControl
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public RmsedVectorRenderControl()
        {
            InitializeComponent();
        }
        ...
        /// 计算结果
        /// </summary>
        protected List<RmsedVector> Adjustments { get; set; } 
        ...
        public void SetResult(List<RmsedVector> Adjustments)
        {
            ...
            foreach (var result in Adjustments)//避免集合修改无法遍历
            {
                ...
                { 
                    ...
                    foreach (var kv in dic)
                    {
                        ...
                        if (indexOfParam != -1)
                        {
                            var qrt = result.GetItem(indexOfParam).Rms;
