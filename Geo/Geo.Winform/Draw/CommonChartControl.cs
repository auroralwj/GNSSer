...
//2018.12.24, czs, edit in hmx, 控件绘图
...
namespace Geo.Winform
{
    ...
    public partial class CommonChartControl : UserControl
    {
        ...
        public void DataBind(List<IEnumerable<Double>> lists, List<string> name)
        {
            InitializeComponent();
        ...
        /// <param name="lists"></param>
        /// <param name="name"></param>
        public void DataBind(List<Dictionary<Double, Double>> lists, List<string> name)
        {
            InitializeComponent();
            Series[] ss = new Series[lists.Count];
            Int32 i = 0;
        ...
        /// <param name="lists"></param>
        /// <param name="name"></param>
        public void DataBind(IEnumerable<Double> lists, string name = "S")
        {
            InitializeComponent();
        ...
        public void DataBind(params Series[] series)
        {
            InitializeComponent();
        ...
        /// <param name="name"></param>
        public void DataBind(List<DataPoint> Points, string name = "S") { DataBind(Points.ToArray(), name); }
        ...
        /// <param name="Points"></param>
        /// <param name="name"></param>
        public void DataBind(DataPoint[] Points, string name = "S")
        {
            InitializeComponent();
            this.Points = Points;
        ...
        public void DataBind(DataTable table, SeriesChartType SeriesChartType = SeriesChartType.Line)
        {
            InitializeComponent();
        ...
        public void DataBind(ObjectTableStorage table, SeriesChartType SeriesChartType = SeriesChartType.Line)
        {
            this.ShowInfo(table.Name);
        ...
        ChartSettingOption Option { get; set; }
        ...
        {
            this.panel_buttons.Visible = !this.panel_buttons.Visible;
        }
        /// <summary>
        /// 显示信息
        /// </summary>
