...
namespace Gnsser.Ntrip.Rtcm
{
    ...
    /// </summary>
    public class GpsNetworkFKPGradientHeader : Geo.IToTabRow
    {
        #region 基本数据属性
        /// <summary>
        /// 报文编号,Uint12,12
        ...
        /// uint5
        /// </summary>
        public uint NoofGpsSatelliteSignalsProcessed { get; set; }
        #endregion
      ...
      //  public double GpsSeconds { get { return this.GpsEpochTimeInMs / 1000.0; } }
        ...
        public string GetTabTitles()
        {
            ...
            sb.Append("\t");
            sb.Append("GpsFKPEpochTime");
            sb.Append("\t");
            sb.Append("NoofGpsSatelliteSignalsProcessed");
            return sb.ToString();
        }
