...
namespace Gnsser.Ntrip.Rtcm
{
    /// <summary>
    /// 412+8*(M+N) bit.
    /// Contents of the Type 1021 Message – Helmert/Abridged Molodenski 
    /// </summary>
    public class Message1021 : BaseRtcmMessage
    {
        /// <summary>
        /// 消息构造函数
        /// </summary> 
        ...
        public static Message1021 Parse(List<byte> data)
        {
            //首先化为二进制字符串
        ...
        public static Message1021 Parse(string binStr)
        {
            StringSequence sequence = new StringSequence();
            sequence.EnQuence(binStr);

            Message1021 msg = new Message1021();
            ...
            msg.Length = 412 + (int)msg.SourceNameCounter * 8 + (int)msg.TargetNameCounter * 8;
            return msg;
        }
    }
}