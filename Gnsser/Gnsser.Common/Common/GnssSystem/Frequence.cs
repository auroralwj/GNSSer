...
namespace Gnsser
{
    ...
    public class Frequence : NumeralValue
    {
        ...
        /// 波长,单位 米
        /// </summary>
        public double WaveLength { get { return GnssConst.LIGHT_SPEED / Value / 1E6; } }
        ...
        /// <param name="time">时间，历元，GLONASS或频分多址需要</param>
        /// <returns></returns>
        public static Frequence GetFrequence(SatelliteNumber prn, int rinexFreqNum, Geo.Times.Time time = default(Geo.Times.Time))
        {
        ...
        /// <returns></returns>
        public static Frequence GetFrequenceA(SatelliteNumber prn, Geo.Times.Time time = default(Geo.Times.Time))
        {
        ...
        /// <param name="time">时间，GLONASS需要</param>
        /// <returns></returns>
        public static Frequence GetFrequenceB(SatelliteNumber prn, Geo.Times.Time time = default(Geo.Times.Time))
        {
        ...
        /// <returns></returns>
        public static Frequence GetFrequenceA(SatelliteType type, int satNumber = -1, Geo.Times.Time time = default(Geo.Times.Time))
        {
        ...
        /// <returns></returns>
        public static Frequence GetFrequenceB(SatelliteType type, int satNumber = -1, Geo.Times.Time time = default(Geo.Times.Time))
        {
        ...
        /// <returns></returns>
        public static Frequence GetFrequenceA(GnssType type, int satNumber = -1, Geo.Times.Time time = default(Geo.Times.Time))
        {
        ...
        /// <param name="time">时间，历元，GLONASS需要</param>
        /// <returns></returns>
        public static Frequence GetFrequenceB(GnssType type, int satNumber = -1, Geo.Times.Time time = default(Geo.Times.Time))
        {
        ...
        /// <param name="time">时间，历元</param>
        /// <returns></returns>
        public static Frequence GetFrequence(SatelliteType type, int rinexNum, int satNumber = -1, Geo.Times.Time time = default(Geo.Times.Time))
        {
