...
//2015.10.15, czs , create in 洪庆, 增加测站某次观测信息 IObservationInfo 类
...
namespace Gnsser
{
    ...
    public class SiteInfo : ISiteInfo
    {
        ...
        public SiteInfo()
        {
            ...
            {
                Geo.Utils.ObjectUtil.GetPropertyName<SiteInfo>(m=>m.SiteName),
               "X", 
               "Y", 
               "Z", 
               "Mx", 
        ...
        /// 天线偏差
        /// </summary>
        public Geo.Coordinates.XYZ AntDeltaXyz { get; set; }

        /// <summary>
        /// 估计值概略坐标
        /// </summary>
        public Geo.Coordinates.GeoCoord EstimatedGeoCoord { get { return Geo.Coordinates.CoordTransformer.XyzToGeoCoord(EstimatedXyz); } } 

        Geo.Coordinates.XYZ approxXyz;
        /// <summary>
        /// 概略坐标.
        /// </summary>
        public Geo.Coordinates.XYZ ApproxXyz
        {
        ...
        Geo.Coordinates.XYZ estimatedXyz;
        /// <summary>
        /// 估值坐标，如果没有设置，则采用概略坐标。.此属性是为了方便坐标更新使用。
        /// </summary>
        public Geo.Coordinates.XYZ EstimatedXyz
        {
        ...
        /// 概略坐标
        /// </summary>
        public Geo.Coordinates.GeoCoord ApproxGeoCoord { get; set; } 
        ...
        public bool IsPrecisePosition
        {
            ...
            {
                //对概略坐标进行简要的判断
                if (this.EstimatedXyz == null || !this.EstimatedXyz.IsValid || this.EstimatedXyz.IsZero)
                    return false;
                //如果没有设置精度信息，则默认为精确
        ...
        /// 天线坐标偏移
        /// </summary>
        public Geo.Coordinates.HEN Hen { get; set; }
        /// <summary>
        /// 字符串
        /// </summary>
        /// <returns></returns>
        ...
        public string GetTabTitles()
        {
            ...
            sb.Append("\t");
            sb.Append("近似坐标" + this.ApproxXyz.GetTabTitles());

            sb.Append("\t");
            sb.Append("天线坐标" + this.Hen.GetTabTitles());
            return sb.ToString();
        }
        /// <summary>
        /// 表内容
        ...
        public string GetTabValues()
        {
            ...
            sb.Append("\t");
            sb.Append(this.ApproxXyz.GetTabValues());

            sb.Append("\t");
            sb.Append(this.Hen.GetTabValues());
            return sb.ToString();
        }
        #endregion
