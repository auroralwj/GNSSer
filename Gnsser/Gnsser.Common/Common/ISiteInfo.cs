...
namespace Gnsser
{
    ...
    /// </summary>
    public interface ISiteInfo : Geo.IToTabRow, ICloneable, IOrderedProperty
    {
         /// <summary>
        ...
        /// </summary>
        Geo.Coordinates.XYZ ApproxXyz { get;  }
        /// <summary>
        /// 计算估值坐标,必须要有赋值！如果没有初始化则采用概略坐标 ApproxXyz。
        /// 在计算中，估值坐标常常会被更新，以获得更好的精度。可以是本历元内迭代，也可以是时间序列传递。
        /// </summary>
        Geo.Coordinates.XYZ EstimatedXyz { get; set; } 

        /// <summary>
        /// 坐标精度指示。用于决定初始坐标是否精确。
        /// </summary>
        Geo.Coordinates.XYZ EstimatedXyzRms { get; set; }
        //  Geo.Coordinates.RmsedXYZ RmsedXyz { get; set; }
        /// <summary>
        /// 概略坐标
        /// </summary>
        Geo.Coordinates.GeoCoord ApproxGeoCoord { get; set; }
        /// <summary>
        /// 概略坐标
        /// </summary>
        Geo.Coordinates.GeoCoord EstimatedGeoCoord { get;   } 
        ...
        /// 计算时需要转换到 NEU。
        /// </summary>
        Geo.Coordinates.HEN Hen { get; set; }
