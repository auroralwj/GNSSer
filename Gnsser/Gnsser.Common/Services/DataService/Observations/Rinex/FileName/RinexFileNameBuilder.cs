...
namespace Gnsser.Data.Rinex
{
    ...
    public class RinexFileNameBuilder : IBuilder<String, Time>, IBuilder<String>
    {
        ...
        public string Build(Time time)
        {
            ...
            {
                int nameLen = 8;
                if (TimeResolution == Geo.Times.TimeUnit.Minute)
                    nameLen = 10;
                if (TimeResolution == Geo.Times.TimeUnit.Second)
                    nameLen = 12;
            ...
            else
            {
                ...
                string Name = Geo.Utils.StringUtil.FillZero(this.StationName, 6) + ContryCode;
                //1 Character – defining the data source
                //  string dataSource = "S";
