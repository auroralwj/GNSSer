...
{ 
    ...
    /// Rinex 观测文件头文件。
    /// </summary>
    public class RinexObsFileHeader : SiteObsInfo, ICloneable, IExtendSiteObsInfo
    {
        /// <summary>
        /// 以基本信息初始化
        /// </summary>
        ...
        /// 是否具有导航文件
        /// </summary>
        public bool HasNavFile => Geo.Utils.FileUtil.IsValid(NavFilePath);
        /// <summary>
        /// 导航文件路径，如果有的话。
        /// </summary>
        ...
        /// </summary>
        public Geo.Coordinates.XYZ AntDeltaXyz { get { return SiteInfo.AntDeltaXyz; } set { SiteInfo.AntDeltaXyz = value; } }
        /// <summary>
        /// 概略坐标.
        /// </summary>
        public Geo.Coordinates.XYZ ApproxXyz { get { return SiteInfo.ApproxXyz; } set { SiteInfo.SetApproxXyz(value); } }
        /// <summary>
        /// 天线坐标偏移
        /// </summary>
        public Geo.Coordinates.HEN Hen { get { return SiteInfo.Hen; } set { SiteInfo.Hen = value; } }
