...
namespace Gnsser.Data
{
    ...
    /// IGS（日，默认）产品地址生成器
    /// </summary>
    public class IgsProductUrlPathBuilder : Geo.AbstractBuilder<string[]>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        public IgsProductUrlPathBuilder(IgsProductType ProductType = IgsProductType.Sp3, int TimeIntervalInSeconds = 86400)
        {
            ...
            SourceNameDic[ SatelliteType.U] =new List<string>(  new string[] { "igs", "wum", "com", "gbm", "qzf", "tum" });
            // wum,gbm,qzf,com, 
            this.TimeIntervalInSeconds = TimeIntervalInSeconds;
            this.SatelliteType = SatelliteType.U;
        }
        ...
        private List<string> BuildWithProductType(List<string> urlModels)
        {
            ...
            {   
                string path  = model
                    .Replace(ELMarker.ProductType, ProductType.ToString()); 
                pathes.Add(path);
            }
            return pathes;
        }
