...
namespace Gnsser.Data.Rinex
{
    ...
    /// </summary>
    public class EphemerisStorage : BaseDictionary<double, Gnsser.Ephemeris>
    {
        /// <summary>
        /// 获取列表
        /// </summary>
        ...
        /// <returns></returns>
        public List<Gnsser.Ephemeris> GetEphemerises(List<double> indexes)
        {
            List<Gnsser.Ephemeris> entities = new List<Gnsser.Ephemeris>();
        ...
        public void Add(IEnumerable<Gnsser.Ephemeris> Ephemerises)
        {
