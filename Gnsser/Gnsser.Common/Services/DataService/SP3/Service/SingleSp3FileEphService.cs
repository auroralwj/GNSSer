...
namespace Gnsser.Data.Rinex
{
    ...
    public class SingleSp3FileEphService : FileEphemerisService
    {
        ...
        /// 星历服务类型
        /// </summary>
        public override EphemerisServiceType ServiceType { get { return EphemerisServiceType.Precise; } }
        /// <summary>
        /// 卫星数量，通过头文件获取
        /// </summary>
        ...
        public override List<Gnsser.Ephemeris> Gets(SatelliteNumber prn, Time from, Time to)
        {
            ...
            if (prnEphes == null) { return new List<Gnsser.Ephemeris>(); }
        ...
        {
            var entities = new List<Gnsser.Ephemeris>();
