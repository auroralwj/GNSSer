...
namespace Gnsser.Data.Rinex
{
    ...
    /// Sp3 记录部分。
    /// </summary>
    public class Sp3AllReader : Geo.IO.AbstractTimedStreamReader<Sp3Section>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
            ...
            //try
            {
               ...
               // if (line.Substring(0, 2) != RecordHeadSymbol) throw new Exception("SP3文件不合法");
                ...
                for (int i = 0; i < header.NumberOfSatellites; i++)
                {
                    ...
                    rec.XYZ = new Geo.Coordinates.XYZ(x, y, z);
                    ...
                    {
                        rec.Rms = new Geo.Coordinates.XYZ(0.0, 0.0, 0.0);
                    ...
                    if (header.P_V_ModeFlag == VelocityClockSymbol)
                    {
                        ...
                        //rec.XyzSdev = new Geo.Coordinates.XYZ(xsdev, ysdev, zsdev);
                        ...
                        rec.XyzDot = new Geo.Coordinates.XYZ(xdot, ydot, zdot);
                        ...
                        //rec.XyzDotSdev = new Geo.Coordinates.XYZ(xVsdev, yVsdev, zVsdev);
                    }
