...
namespace Gnsser
{
    ...
    /// 最轻量级得到钟差表达
    /// </summary>
    public class SimpleClockBias : ISimpleClockBias
    {
        /// <summary>
        /// 默认构造函数
        /// </summary>
    ...
    /// 钟差基础类。
    /// </summary>
    public class SatClockBias : SimpleClockBias, IClockBias, IComparable<SatClockBias>, IToTabRow
    {
        /// <summary>
        /// 默认构造函数
        /// </summary>
        ...
        public virtual string GetTabValues()
        {
            ...
            sb.Append(Time); 
            sb.Append("\t");
            sb.Append(String.Format(new Geo.NumeralFormatProvider(), "{0}", ClockBias));
            sb.Append("\t");
            sb.Append(String.Format(new Geo.NumeralFormatProvider(), "{0}", this.ClockDrift));
