...
namespace Gnsser
{
    ...
    /// </summary>
    public abstract class FileEphemerisService : MultiSatProductService<Ephemeris>, IFileEphemerisService
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        /// <returns></returns>
        public virtual int CompareTo(IEphemerisService other) { return this.TimePeriod.CompareTo(other.TimePeriod); } 
