...
namespace Gnsser.Service
{
    ...
    /// 3）SOA模型的服务，等等。
    /// </summary>
    public interface IEphemerisService : IMultiSatProductService<Ephemeris>,
        IGnssFileService, IComparable<IEphemerisService> 
    {
          /// <summary>
        /// 星历服务类型
        /// </summary>
        EphemerisServiceType ServiceType { get; } 
        /// <summary>
        /// 卫星数量
        /// </summary>
        int SatCount { get; }
