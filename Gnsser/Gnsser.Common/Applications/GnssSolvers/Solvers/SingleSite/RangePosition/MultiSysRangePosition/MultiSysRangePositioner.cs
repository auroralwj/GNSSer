...
//2017.09.04, lly, edit in zz,  多系统伪距定位
//2017.09.05, czs, edit in hongqing, 整理代码，多系统伪距定位
...
namespace Gnsser.Service
{
    ...
    /// 多系统伪距定位 
    /// </summary>
    public class MultiSysRangePositioner : SingleSiteGnssSolver
    {
        #region 构造函数 
        /// <summary>
        /// 多系统伪距定位
        ...
        public MultiSysRangePositioner(DataSourceContext DataSourceContext, GnssProcessOption PositionOption)
            : base(DataSourceContext, PositionOption)
        {
            this.Name = "多系统伪距定位";
          
            this.BaseParamCount = 4;
            this.MatrixBuilder = new MultiSysRangeMatrixBuilder(this.Option); 
