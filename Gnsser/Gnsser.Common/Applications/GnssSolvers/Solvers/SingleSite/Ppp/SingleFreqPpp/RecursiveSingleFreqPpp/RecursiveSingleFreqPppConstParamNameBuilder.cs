...
namespace Gnsser.Service
{
    ...
    /// 固定参数
    /// </summary>
    public class RecursiveSingleFreqPppConstParamNameBuilder : GnssParamNameBuilder
    {
         /// <summary>
        /// 构造函数
        /// </summary>
        public RecursiveSingleFreqPppConstParamNameBuilder(GnssProcessOption option) :base(option)
        {
