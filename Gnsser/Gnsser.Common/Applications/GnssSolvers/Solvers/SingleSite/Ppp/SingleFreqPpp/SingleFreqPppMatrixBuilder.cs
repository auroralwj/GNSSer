...
namespace Gnsser.Service
{
    ...
    /// 非组合精密单点定位矩阵生成类。
    /// </summary>
    public class SingleFreqPppMatrixBuilder : BasePppPositionMatrixBuilder
    {
        /// <summary>
        /// 精密单点定位矩阵生成类 构造函数。
        /// </summary> 
        /// <param name="option">解算选项</param> 
        public SingleFreqPppMatrixBuilder(
            ...
            : base(option)
        {
            ...
            ParamNameBuilder = new SingleFreqPppParamNameBuilder(option);//option中包含了几个系统             
        }
        ...
        /// </summary>
        public override IVector ObservationVector
        {
            get
            {
        ...
        /// <returns></returns>
        protected override IMatrix BulidInverseWeightOfObs()
        {
