...
namespace Gnsser.Service
{
    ...
    /// 单站多历元GNSS计算参数命名器
    /// </summary>
    public class SingleSitePeriodParamedIonoParamNameBuilder : GnssParamNameBuilder
    {
        /// <summary>
        /// 单站多历元GNSS计算参数命名器
        /// </summary>
        /// <param name="option"></param>
        public SingleSitePeriodParamedIonoParamNameBuilder(GnssProcessOption option)
            : base(option)
        { 
