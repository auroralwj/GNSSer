...
namespace Gnsser
{
    ...
    /// WM 平滑管理器，为了无电离层双差网解
    /// </summary>
    public class SmoothMwProviderManager : BaseDictionary<string, SmoothMwProvider>
    {
        /// <summary>
        /// 默认构造函数
        /// </summary>
        ...
        public SmoothMwProviderManager(int epochCount = 120, double breakSpanSeconds = 121)
            :base("MW平滑管理器", new Func<string, SmoothMwProvider>(str=>new SmoothMwProvider(epochCount, breakSpanSeconds)))
        {
        }
