...
namespace Gnsser.Service
{
    ...
    /// 双差网解定位参数命名器
    /// </summary>
    public class RecursiveNetDoubleDifferPositionParamNameBuilder : GnssParamNameBuilder
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public RecursiveNetDoubleDifferPositionParamNameBuilder(GnssProcessOption option)  :base(option)
        {
