...
namespace Gnsser.Service
{
    ...
    /// 简易近距离单历元载波相位双差参数命名器
    /// </summary>
    public class EpochDualFreqDoubleDifferParamNameBuilder : GnssParamNameBuilder
    {
        /// <summary>
        /// 简易近距离单历元载波相位双差参数命名器
        /// </summary>
        ...
        public EpochDualFreqDoubleDifferParamNameBuilder(GnssProcessOption Option, int baseParamCount)
            : base(Option)
        {
        ...
        public override List<string> Build()
        {
            ...
            foreach (var prn in this.EnabledPrns)
            {
                ...
                paramNames.Add(GetParamNameOfL2(prn));
            }
            return paramNames;
        }
        ...
        public   string GetParamNameOfL2(SatelliteNumber prn)
        {
