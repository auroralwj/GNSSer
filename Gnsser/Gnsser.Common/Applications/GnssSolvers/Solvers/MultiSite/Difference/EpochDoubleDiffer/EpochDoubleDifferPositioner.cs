...
namespace Gnsser.Service
{
    ...
    /// </summary>
    public class EpochDoubleDifferPositioner : MultiSiteEpochSolver
    {
        #region 构造函数 
        /// <summary>
        /// 构造函数
        ...
        public EpochDoubleDifferPositioner(DataSourceContext Context, GnssProcessOption Option)
        :base( Context,   Option)
        { 
            ...
            this.MatrixBuilder = new EpochDoubleDifferMatrixBuilder(base.Option, BaseParamCount);
        }
        ...
        {
            var result = new EpochDoubleDifferPositionResult(this.CurrentMaterial, Adjustment, this.MatrixBuilder.GnssParamNameBuilder, CurrentBasePrn);
            return result;
        }
    }
}
