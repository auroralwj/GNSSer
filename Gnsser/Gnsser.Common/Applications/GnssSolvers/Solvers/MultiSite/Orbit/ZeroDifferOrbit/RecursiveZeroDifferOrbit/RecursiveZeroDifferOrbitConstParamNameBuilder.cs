...
namespace Gnsser.Service
{
    ...
    /// 固定参数
    /// </summary>
    public class RecursiveZeroDifferOrbitConstParamNameBuilder : ZeroDifferOrbitParamNameBuilder
    {
         /// <summary>
        /// 构造函数
        /// </summary>
        public RecursiveZeroDifferOrbitConstParamNameBuilder(GnssProcessOption option) :base(option)
        {
