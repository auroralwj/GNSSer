...
namespace Gnsser
{
    ...
    /// 使用哈达码方差的kalman模型
    /// </summary>
    public class KalmanHardamard : BasicFunctionModel
    {
        /// <summary>
        /// 计算
        /// </summary>
        ...
        public void Calculate(ArrayMatrix ModelData, ArrayMatrix CompareData, int IntervalSeconds)
        {
            ...
            ArrayMatrix X = GetKalmanFilter(ModelLength, InitialX, CovarianceV, InitialCovarianceX, InitialCovarianceW, ModelData, CovarianceByHardamardDevariation);
