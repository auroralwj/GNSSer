...
namespace Gnsser.Service
{
    ...
    /// </summary>
    public class SingleSitePeriodGnssExtentMatrixBuilder : SingleSitePeroidMatrixBuilder 
    {
        #region 构造函数
        /// <summary>
        /// 载波相位双差定位矩阵生成器，构造函数。
        ...
        public SingleSitePeriodGnssExtentMatrixBuilder(
            GnssProcessOption model)
            : base(model)
        {
            this.ParamNameBuilder = new SingleSitePeriodGnssExtentParamNameBuilder(this.Option);
        }
        #endregion
