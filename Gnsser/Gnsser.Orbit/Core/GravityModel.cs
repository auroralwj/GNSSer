...
{
    /// <summary>
    /// Gravity model record,重力模型。
    /// </summary>
    public struct GravityModel
    {
        /// <summary>
        /// Degree
        /// </summary>
        ...
        public int m_max;
        /// <summary>
        /// Gravitational coefficient [m^3/s^2]
        /// </summary>
        public double GM;
        /// <summary>
        /// Reference radius [m]
        ...
        public double R_ref;
        /// <summary>
        ///  Unnormalized harmonic coefficients (C_nm, S_nm)
        /// </summary>
        public Matrix CS;
        ...
        /// <param name="gm"> Gravitational coefficient [m^3/s^2]</param>
        /// <param name="r_ref">Reference radius [m]</param>
        /// <param name="p_cs">不规则的球谐系数。Unnormalized harmonic coefficients (C_nm, S_nm)</param> 
        public GravityModel(int n, double gm, double r_ref, double[][] p_cs)
        {
            n_max = (n);
            m_max = (n);
            GM = (gm);
            R_ref = (r_ref);
            CS = new Matrix(p_cs, n + 1, n + 1);
        }
        ...
        const double R_JGM3 = 6378.11363e3;           // Radius Earth [m]; JGM3
        const int N_JGM3 = 20;
        // const double CS_JGM3[N_JGM3+1][N_JGM3+1] = {
        static double[][] CS_JGM3 = new double[N_JGM3 + 1][] {//N_JGM3+1
    new double [] { 1.000000e+00, 0.000000e+00, 1.543100e-09, 2.680119e-07,-4.494599e-07,     
     ...
     -8.128915e-08,-1.646546e-08,-2.378448e-08, 2.172109e-08, 1.443750e-08,     
      ...
      2.759192e-09                                                       },     
     new double [] { 0.000000e+00, 0.000000e+00,-9.038681e-07,-2.114024e-07, 1.481555e-07,     
     ...
     -1.045474e-09, 7.856272e-10, 2.522818e-10, 3.427413e-10,-1.008909e-10,     
      3.216826e-10                                                       },     
     new double [] {-1.082627e-03,-2.414000e-10, 1.574536e-06, 1.972013e-07,-1.201129e-08,     
     ...
     -8.989333e-10,-6.863521e-10, 9.154575e-11, 3.005522e-10, 5.182512e-11,     
      ...
      3.778260e-11                                                       },     
     new double [] { 2.532435e-06, 2.192799e-06, 3.090160e-07, 1.005589e-07, 6.525606e-09,     
     ...
     -1.178441e-12                                                       },     
     new double [] {1.619331e-06,-5.087253e-07, 7.841223e-08, 5.921574e-08,-3.982396e-09,     
     ...
     -1.823414e-14                                                       },     
     new double [] {2.277161e-07,-5.371651e-08, 1.055905e-07,-1.492615e-08,-2.297912e-09,     
     ...
     -5.637288e-17                                                       },     
     new double [] {-5.396485e-07,-5.987798e-08, 6.012099e-09, 1.182266e-09,-3.264139e-10,     
     ...
     -8.899420e-19                                                       },     
     new double [] {3.513684e-07, 2.051487e-07, 3.284490e-08, 3.528541e-09,-5.851195e-10,     
     ...
     -1.052843e-14, 1.170448e-15, 3.701523e-16,-1.095673e-16,-9.074974e-17,     
      ...
      1.459810e-18                                                       },     
     new double [] {2.025187e-07, 1.603459e-08, 6.576542e-09,-1.946358e-10,-3.189358e-10,     
     ...
     -1.128428e-19                                                       },     
     new double [] {1.193687e-07, 9.241927e-08, 1.566874e-09,-1.217275e-09,-7.018561e-12,     
     ...
     -6.100911e-21                                                       },     
     new double [] {2.480569e-07, 5.175579e-08,-5.562846e-09,-4.195999e-11,-4.967025e-11,     
     ...
     -1.138734e-21                                                       },     
     new double [] {-2.405652e-07, 9.508428e-09, 9.542030e-10,-1.409608e-10,-1.685257e-11,     
     ...
     -4.946396e-17, 9.351706e-18,-9.838299e-20, 1.643922e-19,-1.658377e-20,     
      ...
      6.435154e-23                                                       },     
     new double [] {1.819117e-07,-3.068001e-08, 6.380398e-10, 1.451918e-10,-2.123815e-11,     
     ...
     -8.660491e-23, 6.651727e-24, 5.110031e-23,-3.635064e-23,-1.311958e-23,     
      1.534228e-24                                                       },     
     new double [] {2.075677e-07,-2.885131e-08, 2.275183e-09,-6.676768e-11,-3.452537e-13,     
     ...
     -2.046569e-25                                                       },     
      new double [] {-1.174174e-07,-9.997710e-09,-1.347496e-09, 9.391106e-11, 3.104170e-13,     
     ...
     -7.473051e-28                                                       },     
     new double [] {1.762727e-08, 6.108862e-09,-7.164511e-10, 1.128627e-10,-6.013879e-12,     
     ...
     -9.295855e-24, 5.687404e-26, 1.057368e-26, 4.931703e-27,-1.480665e-27,     
      2.400400e-29                                                       },     
     new double [] {-3.119431e-08, 1.356279e-08,-6.713707e-10,-6.451812e-11, 4.698674e-12,     
     ...
     -8.192994e-29                                                       },     
     new double [] {1.071306e-07,-1.262144e-08,-4.767231e-10, 1.175560e-11, 6.946241e-13,     
     ...
     -5.508346e-31                                                       },     
     new double [] {4.421672e-08, 1.958333e-09, 3.236166e-10,-5.174199e-12, 4.022242e-12,     
     ...
     -2.898577e-25, 7.555273e-27, 3.046776e-28, 3.696154e-29, 1.845778e-30,     
      6.948820e-31                                                       },     
     new double [] {-2.197334e-08,-3.156695e-09, 7.325272e-10,-1.192913e-11, 9.941288e-13,     
     ...
     -1.237749e-31                                                       },     
     new double [] {1.203146e-07, 3.688524e-09, 4.328972e-10,-6.303973e-12, 2.869669e-13,     
     ...
     -2.520877e-26,-8.774566e-28, 2.651434e-29, 8.352807e-30,-1.878413e-31,     
      4.054696e-32                                                       }     
        ...
        public static GravityModel Grav = new GravityModel(N_JGM3,            // Degree and order
                               OrbitConsts.GM_Earth,          // Gravitational coefficient [m^3/s^2]
                               R_JGM3,            // Reference radius [m]
                               CS_JGM3); // Unnormalized harmonic coefficients
        #endregion
