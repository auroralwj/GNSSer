...
namespace Gnsser.Winform
{
    public partial class ObsFileSelectOptionForm : Form
    {
        ...
        private void Init()
        {
            enabledFloatControl_mp1Factor.Init("多路径效应MP1值过滤：", 0.6);
            enabledFloatControl_mp2Factor.Init("多路径效应MP2值过滤：", 0.6);
        }
        ...
        private void EntityToUi ()
        {
            ...
            this.textBox_obsCodes.Text = Geo.Utils.StringUtil.GetFormatedString<string>(Option.ObsCodes, ",");
            this.textBox_includeSiteNames.Text = Geo.Utils.StringUtil.GetFormatedString<string>(Option.IncludeSiteNames, ",");
            this.textBox_excludeSites.Text = Geo.Utils.StringUtil.GetFormatedString<string>(Option.ExcludeSiteNames, ",");
