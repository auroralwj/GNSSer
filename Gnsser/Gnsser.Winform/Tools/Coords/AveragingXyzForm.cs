...
{
    public partial class AveragingXyzForm : Form
    {
        public AveragingXyzForm()
        {
            InitializeComponent();
        }
        ...
        private void fileOpenControlA_FilePathSetted(object sender, EventArgs e)
        {
            ...
            {
                fileOutputControl1.FilePath = Path.Combine(Path.GetDirectoryName(this.fileOpenControlA.FirstPath), "AveragedGnsserCoord.xls");
            }
        }
    }
}
