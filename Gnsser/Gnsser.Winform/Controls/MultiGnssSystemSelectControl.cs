...
namespace Gnsser.Winform.Controls
{
    ...
    public partial class MultiGnssSystemSelectControl : UserControl
    {
        ...
        {
            InitializeComponent();
            if (Setting.IsBDsEnabled)
            {
                this.SatelliteTypes = new List<SatelliteType>(){
                     SatelliteType.C
                };
            }
            if (Setting.VersionType != Geo.VersionType.Development && !Setting.IsEnableMultiSystem)
            {
                if (this.SatelliteTypes == null)
                {
                    this.SatelliteTypes = new List<SatelliteType>(){
                     SatelliteType.G
                };
        ...
        public List<SatelliteType> SatelliteTypes
        {
            get
            {
                ...
                if (this.checkBox_IRNSS.Checked) satelliteTypes.Add(SatelliteType.I);
           ...
           protected set
            { 
                ...
                this.checkBox_IRNSS.Checked = value.Contains(SatelliteType.I);
